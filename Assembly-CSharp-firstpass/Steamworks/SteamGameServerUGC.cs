...
namespace Steamworks
{
  public static class SteamGameServerUGC
  {
    ...
    public static bool GetQueryUGCPreviewURL(UGCQueryHandle_t handle, uint index, out string pchURL, uint cchURLSize)
    {
      ...
      pchURL = !queryUgcPreviewUrl ? (string) null : InteropHelp.PtrToStringUTF8(num);
    ...
    public static bool GetQueryUGCMetadata(UGCQueryHandle_t handle, uint index, out string pchMetadata, uint cchMetadatasize)
    {
      ...
      pchMetadata = !queryUgcMetadata ? (string) null : InteropHelp.PtrToStringUTF8(num);
      Marshal.FreeHGlobal(num);
    ...
    public static bool GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, uint index, uint previewIndex, out string pchURLOrVideoID, uint cchURLSize, out bool pbIsImage)
    {
      InteropHelp.TestIfAvailableGameServer();
      IntPtr num = Marshal.AllocHGlobal((int) cchURLSize);
      bool additionalPreview = NativeMethods.ISteamGameServerUGC_GetQueryUGCAdditionalPreview(handle, index, previewIndex, num, cchURLSize, out pbIsImage);
      pchURLOrVideoID = !additionalPreview ? (string) null : InteropHelp.PtrToStringUTF8(num);
      Marshal.FreeHGlobal(num);
    ...
    public static bool GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, uint index, uint keyValueTagIndex, out string pchKey, uint cchKeySize, out string pchValue, uint cchValueSize)
    {
      ...
      pchKey = !queryUgcKeyValueTag ? (string) null : InteropHelp.PtrToStringUTF8(num1);
      Marshal.FreeHGlobal(num1);
      pchValue = !queryUgcKeyValueTag ? (string) null : InteropHelp.PtrToStringUTF8(num2);
