...
namespace Pathfinding
{
  ...
  public class NodeLink2 : GraphModifier
  {
    ...
    {
      NodeLink2 nodeLink2;
      NodeLink2.reference.TryGetValue(node, out nodeLink2);
      return nodeLink2;
    }
    ...
    public void InternalOnPostScan()
    {
      ...
      NodeLink2 nodeLink2_1;
      if (this.startNode != null && NodeLink2.reference.TryGetValue((GraphNode) this.startNode, out nodeLink2_1) && (UnityEngine.Object) nodeLink2_1 == (UnityEngine.Object) this)
        NodeLink2.reference.Remove((GraphNode) this.startNode);
      NodeLink2 nodeLink2_2;
      if (this.endNode != null && NodeLink2.reference.TryGetValue((GraphNode) this.endNode, out nodeLink2_2) && (UnityEngine.Object) nodeLink2_2 == (UnityEngine.Object) this)
    ...
    public void Apply(bool forceNewCheck)
    {
      ...
      int num = (int) this.startNode.GraphIndex;
      none.graphMask = ~(1 << num);
      ...
      if (this.connectedNode2 == null || forceNewCheck)
      {
        ...
        this.connectedNode2 = nearest.node as MeshNode;
    ...
    {
      Color col = !selected ? NodeLink2.GizmosColor : NodeLink2.GizmosColorSelected;
