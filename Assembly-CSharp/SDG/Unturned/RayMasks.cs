...
namespace SDG.Unturned
{
  public class RayMasks
  {
    ...
    public static readonly int PLAYER_INTERACT = RayMasks.ENEMY | RayMasks.ITEM | RayMasks.RESOURCE | RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.ENVIRONMENT | RayMasks.GROUND | RayMasks.VEHICLE | RayMasks.BARRICADE | RayMasks.STRUCTURE | RayMasks.DEFAULT;
    public static readonly int EDITOR_INTERACT = RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.SMALL;
    public static readonly int EDITOR_WORLD = RayMasks.RESOURCE | RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.ENVIRONMENT | RayMasks.GROUND | RayMasks.GROUND2;
    ...
    public static readonly int BLOCK_ITEM = RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.ENVIRONMENT | RayMasks.GROUND | RayMasks.BARRICADE | RayMasks.STRUCTURE;
    ...
    public static readonly int BLOCK_BARRICADE = RayMasks.RESOURCE | RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.ENVIRONMENT | RayMasks.BARRICADE | RayMasks.STRUCTURE;
    public static readonly int BLOCK_STRUCTURE = RayMasks.VEHICLE | RayMasks.BARRICADE | RayMasks.STRUCTURE;
    public static readonly int BLOCK_EXPLOSION = RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.GROUND;
    ...
    public static readonly int DAMAGE_CLIENT = RayMasks.ENEMY | RayMasks.ENTITY | RayMasks.ENTITY | RayMasks.RESOURCE | RayMasks.LARGE | RayMasks.MEDIUM | RayMasks.ENVIRONMENT | RayMasks.GROUND | RayMasks.VEHICLE | RayMasks.BARRICADE | RayMasks.STRUCTURE;
    ...
    public static readonly int DAMAGE_EXPLOSION = RayMasks.PLAYER | RayMasks.AGENT | RayMasks.BARRICADE | RayMasks.STRUCTURE | RayMasks.VEHICLE | RayMasks.RESOURCE;
