...
namespace SDG.Unturned
{
  public class CommandDay : Command
  {
    ...
    protected override void execute(CSteamID executorID, string parameter)
    {
      ...
      {
        LightingManager.time = (uint) ((double) LightingManager.cycle * (double) LevelLighting.transition);
        CommandWindow.Log((object) this.localization.format("DayText"));
      }
    }
  }
}
