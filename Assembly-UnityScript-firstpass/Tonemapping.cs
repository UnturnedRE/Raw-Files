...
public class Tonemapping : PostEffectsBase
{
  ...
  public virtual void OnRenderImage(RenderTexture source, RenderTexture destination)
  {
    ...
    {
      this.exposureAdjustment = (double) this.exposureAdjustment >= 1.0 / 1000.0 ? this.exposureAdjustment : 1.0 / 1000.0;
      ...
      else
      {
        ...
        RenderTexture renderTexture = renderTextureArray[length - 1];
        ...
        if (this.type == Tonemapping.TonemapperType.AdaptiveReinhardAutoWhite)
        {
          for (int index = 0; index < length - 1; ++index)
          {
            ...
            renderTexture = renderTextureArray[index + 1];
          }
        }
        ...
        this.adaptionSpeed = (double) this.adaptionSpeed >= 1.0 / 1000.0 ? this.adaptionSpeed : 1.0 / 1000.0;
        this.tonemapMaterial.SetFloat("_AdaptionSpeed", this.adaptionSpeed);
        this.rt.MarkRestoreExpected();
        Graphics.Blit((Texture) renderTexture, this.rt, this.tonemapMaterial, !internalRenderTexture ? 2 : 3);
        this.middleGrey = (double) this.middleGrey >= 1.0 / 1000.0 ? this.middleGrey : 1.0 / 1000.0;
