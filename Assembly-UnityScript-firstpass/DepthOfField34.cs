...
public class DepthOfField34 : PostEffectsBase
{
  ...
  public DepthOfField34()
  {
    ...
    this.oneOverBaseSize = 1.0 / 512.0;
  ...
  public virtual void OnRenderImage(RenderTexture source, RenderTexture destination)
  {
    ...
    {
      if ((double) this.smoothness < 0.100000001490116)
      ...
      float num3 = this.focalSize / (this.GetComponent<Camera>().farClipPlane - this.GetComponent<Camera>().nearClipPlane);
      bool blurForeground;
      if (this.simpleTweakMode)
      {
        this.focalDistance01 = !(bool) ((UnityEngine.Object) this.objectFocus) ? this.FocalDistance01(this.focalPoint) : this.GetComponent<Camera>().WorldToViewportPoint(this.objectFocus.position).z / this.GetComponent<Camera>().farClipPlane;
        this.focalStartCurve = this.focalDistance01 * this.smoothness;
        this.focalEndCurve = this.focalStartCurve;
        int num4 = flag ? 1 : 0;
        if (num4 != 0)
          num4 = (double) this.focalPoint > (double) this.GetComponent<Camera>().nearClipPlane + (double) Mathf.Epsilon ? 1 : 0;
      ...
      else
      {
        ...
        {
          Vector3 vector3 = this.GetComponent<Camera>().WorldToViewportPoint(this.objectFocus.position);
          vector3.z = vector3.z / this.GetComponent<Camera>().farClipPlane;
          this.focalDistance01 = vector3.z;
        }
        else
