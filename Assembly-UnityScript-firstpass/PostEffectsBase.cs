...
public class PostEffectsBase : MonoBehaviour
{
  ...
  public virtual Material CheckShaderAndCreateMaterial(Shader s, Material m2Create)
  {
    ...
    if ((bool) ((UnityEngine.Object) m2Create))
      return m2Create;
    return (Material) null;
  }
  ...
  {
    Debug.LogWarning((object) RuntimeServices.op_Addition(RuntimeServices.op_Addition("The image effect ", this.ToString()), " has been disabled as it's not supported on the current platform."));
  }
