...
public class Triangles : MonoBehaviour
{
  ...
  public static bool HasMeshes()
  {
    if (Triangles.meshes == null)
      return false;
    int index = 0;
    Mesh[] meshArray = Triangles.meshes;
    for (int length = meshArray.Length; index < length; ++index)
    {
      if ((UnityEngine.Object) null == (UnityEngine.Object) meshArray[index])
        return false;
    }
    return true;
  }
  ...
  public static void Cleanup()
  {
    ...
    for (int length = meshArray.Length; index < length; ++index)
    {
      if ((UnityEngine.Object) null != (UnityEngine.Object) meshArray[index])
      {
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) meshArray[index]);
        meshArray[index] = (Mesh) null;
      }
    }
